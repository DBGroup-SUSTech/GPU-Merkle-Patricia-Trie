...
//   std::vector<std::string> columns = {"method", "data_num", "throughput"};
//   exp_util::CSVDataRecorder e2e_recorder(columns, "./data/e2e_wiki.csv");
//   exp_util::CSVDataRecorder insert_recorder(columns, "./data/insert_wiki.csv");
//   exp_util::CSVDataRecorder hash_recorder(columns, "./data/hash_wiki.csv");
...
//             segments[1].value_hp_, insert_num, insert_recorder);
//     gpu_hash.start();
//     gpu_mpt_olc.hash_onepass_v2(d_hash_nodes, hash_nodes_num);
//     gpu_hash.stop();
//     olc.stop();
...
//   exp_util::CSVDataRecorder recorder({"method", "rwratio", "throughput"},"./data/rw.csv");
...
TEST(EXPERIMENTS, Uniform) {
  ...
  std::vector<std::string> columns = {"method" ,"data_num", "throughput"};
  exp_util::CSVDataRecorder uniform_recorder(columns, "./data/uniform.csv");
