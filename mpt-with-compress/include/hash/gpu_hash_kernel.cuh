...
__global__ void keccak_squeeze_kernel(uint64_t *data)
{                                  /* In case a digest of length   */
...
__global__ void keccak_kernel(uint64_t *data, uint64_t *out, uint64_t databitlen)
{
