...
void read_ycsb_data_insert(std::string file_name, uint8_t* out_key, int * key_index, uint8_t* out_value, int * value_index, int &n) {
...
void read_ycsb_data_read(std::string file_name, uint8_t* out, int * index, int &n) {
